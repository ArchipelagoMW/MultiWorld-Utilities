...
| hint_cost             | int                                           | The percentage of total locations that need to be checked to receive a hint from the server. Set to a value greater than 100 to disable hints.                                                                                        |
